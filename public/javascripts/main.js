...
(function () {
    Ext.onReady(function () {
        ...
        var userid = Ext.getDom('usrid').value;
        var newUunit = uunit;
        if (uunit.length > 0) {
...
function handlerMenus(menutext) {
    ...
    //     if (Ext.getCmp('userunitui')) {
    //         tab.setActiveTab('userunitui');
    //         return;
    //     }
    //     var item = {
    //         id: 'userunit',
    //         closable: true,
    //         title: '部门管理',
    //         html: '<iframe id="userunitui" name="userunitui" src="/users/userunit" style="width:100%; height:100%;" frameborder="0"></iframe>'
    //     };
    //     tab.add(item);
    //     tab.setActiveTab('userunitui');
